...
<!-- Footer End -->
		...
		<div class="contact-page-section sec-spacer" style="margin-top:-600px" >
        	<div class="container">
						...
						<fieldset>
							...
							<div class="row">                                
                                ...
                                <div class="form-group">
                                        ...
                                        <option value="your_are" >Student</option>
                                        <option value="your_are" >Parent</option>
                                        <option value="your_are" >Counselor</option>                           
                                        </select>
                                    </div>
								</div>
							</div>
                                ...
                                <div class="col-md-6 col-sm-12">
									<div class="form-group">
                                        ...
                                        <select name="country_code" id="">
                                            <option data-country_code="GB" value="44" Selected>UK (+44)</option>
