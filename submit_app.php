            ...
            <div class="container">
                ...
                <div class="row">               
                    <div class="col-lg-12 col-md-12">
                        ...
                            <h1>Applying for Admission to a U.S. University
                        </h1>
                        <br>
                        <p>
                        ...
                        <br><br>
                        <h2>WRITE TO SEVERAL SCHOOLS</h2>

                        After you have selected the schools you want to attend, contact each school for an application form and more international student admission information. You can use the school advertisements throughout this magazine as information resources to help you make your choice. On the website, you can contact schools directly to request information.
                        <br><br>
                        ...
                        <br><br>
                        <h2>REGISTER FOR ADMISSIONS TESTS</h2>
                        ...
                        <br><br>
                        <h3>Most applications will request the following information:</h3>
                        <br>
                        <ul class="points">
                            <li><b>Personal information</b> — Include your name, age, address, family background, birthplace, citizenship, and so on.</li>
                            <li><b>Activities</b> — Make a list of club memberships, awards earned, team sports experience, or leadership roles you have held.</li>
                            <li><b>Education plan</b> — Write a short essay explaining why you want to attend this school, what course of study you want to pursue, your career goals, and research plans.</li>
                            <li><b>Essay</b> — Some schools require a personal essay on a topic of your choosing. See sidebar. </li>
                            <li><b>Letters of recommendation</b> — The application form will include several blank pages for your letters of recommendation. Ask several of your teachers to compose and mail these letters directly to the admissions office of each school you choose.</li>
                        </ul>
                        ...
                        <ul class="points">
                            <li><b>Take plenty of time to prepare for each test.
                        </b> Use available preparation materials to familiarize yourself with the test’s structure and guidelines. Instructions on taking computer- and paper-based tests are generally available for each exam.</li>
                            <li><b>Use available sample questions and exercises.
                        </b> Examples of authentic questions and previously used topics are often available, as well as sample tests. Get as much practice as you can before taking the actual exam.</li>
                            <li><b>Simulate the test situation.
                        </b> Find out as much as you can about the test environment, and practice in a similar setting. Allow yourself only the time allocated for the actual test. Practice working through sections as quickly and effectively as possible, identifying and focusing on areas where you need improvement.</li>
                            <li><b>Take advantage of all the resources available to you.
                        </b> The more you know about a test and how it is scored, the more efficiently you can approach it. The Web is an excellent resource, and most online information is free. Make the most of the advice and materials that can help you achieve success.</li>
                            <li><b>Follow directions.</b>
                         Read all the instructions thoroughly and completely before beginning any test. Make sure you understand your objectives and how to achieve them. Don’t worry if you don’t know an answer—concentrate on the current question, and do the best you can, but don’t spend too much time on any one item. Pace yourself so you have enough time to answer every question.</li>
                            <li><b>Be relaxed and confident.</b>
                         Get plenty of rest before any exam. Remember, the more rested and better prepared you are, the more comfortable and positive you’ll be during the test.</li>
                        </ul>
